...
namespace rlglnet
{
    //Source: https://procedural-content-generation.fandom.com/wiki/Simplex_Noise#:~:text=Simplex%20noise%20is%20an%20improved,the%20shape%20is%20a%20triangle.
    public class SimplexNoise
    {
        ...
        public static double NoiseValue(
            double x,
            double y,
            int    octaves,
            double frequency,
            ...
            double roughness)
        {
            ...
            {
                value += amplitude * 0.5*(1.0 + noise(frequency * x, frequency * y));
